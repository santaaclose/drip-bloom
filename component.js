...
var GlassRingsShop = () => {
    ...
    const handleScroll = () => {
      if (!ticking && !isAnimating) {
        requestAnimationFrame(() => {
          ...
          if (currentScrollY <= 40 || scrollDirection === "up" && currentScrollY <= headerHeight + 50) {
            shouldShow = true;
          } else if (scrollDirection === "down" && currentScrollY > headerHeight) {
            shouldShow = false;
          } else {
            shouldShow = isHeaderVisible;
          }
  ...
  const handleTouchStart = (e, ringId) => {
    setTouchStart({
  ...
  const handleTouchEnd = (ringId, imagesLength) => {
    if (!touchStart.x || !touchEnd.x) return;
    const deltaX = touchStart.x - touchEnd.x;
    const deltaY = Math.abs(touchStart.y - touchEnd.y);
    if (Math.abs(deltaX) > 50 && deltaY < 100) {
      const currentIndex = selectedImageIndex[ringId] || 0;
      let newIndex;
      if (deltaX > 0) {
      ...
      handleImageChange(ringId, newIndex);
    }
...
${message}`);
  ...
  const CatalogPage = () => /* @__PURE__ */ React.createElement("div", { className: "min-h-screen", style: { backgroundColor: "#FAFAFA" } }, /* @__PURE__ */ React.createElement(
    "header",
    {
      className: `backdrop-blur-sm sticky top-0 z-10 border-b transition-all duration-500 ease-in-out ${isHeaderVisible ? "translate-y-0 opacity-100" : "-translate-y-full opacity-0"}`,
      style: {
        background: "linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(250, 248, 246, 0.95) 50%, rgba(252, 250, 248, 0.98) 100%)",
        borderColor: "rgba(138, 115, 85, 0.2)",
        boxShadow: "0 4px 32px rgba(238, 193, 229, 0.12)"
      }
    },
    ...
    "div",
    {
      ...
      style: {
        ...
        borderColor: "rgba(138, 115, 85, 0.15)",
        boxShadow: "0 2px 16px rgba(0, 0, 0, 0.03)"
      }
    },
    /* @__PURE__ */ React.createElement("div", { className: "max-w-md mx-auto px-8 py-8" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-4" }, /* @__PURE__ */ React.createElement("h3", { className: "font-medium", style: { color: "#4A3540" } }, "\u0424\u0438\u043B\u044C\u0442\u0440\u044B"), /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        onMouseOut: (e) => {
          e.target.style.backgroundColor = "#F8F3F6";
          e.target.style.color = "#8B5A6B";
        }
      },
      "\u0421\u0431\u0440\u043E\u0441\u0438\u0442\u044C"
    )), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs mb-3 font-medium tracking-wider", style: { color: "#5A4832" } }, "\u041A\u041E\u041B\u041B\u0415\u041A\u0426\u0418\u0418"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, collections.map((collection) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: collection,
        ...
        style: {
          backgroundColor: selectedFilters.collection === collection ? "#F0EAF2" : "#FFFFFF",
          color: selectedFilters.collection === collection ? "#4A3540" : "#5A4832",
          border: "1px solid " + (selectedFilters.collection === collection ? "#C4A1C9" : "#E5DDD7"),
      ...
      collection
    )))), /* @__PURE__ */ React.createElement("div", { className: "mb-4" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs mb-3 font-medium tracking-wider", style: { color: "#5A4832" } }, "\u0426\u0415\u041D\u0410"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, priceRanges.map((range) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: range.value,
        ...
        className: "px-5 py-3 rounded-2xl text-xs transition-all duration-500 ease-in-out transform hover:scale-105 font-light shadow-sm",
        style: {
          backgroundColor: selectedFilters.priceRange === range.value ? "#E8F5EA" : "#FFFFFF",
          color: selectedFilters.priceRange === range.value ? "#1F4127" : "#5A4832",
          border: "1px solid " + (selectedFilters.priceRange === range.value ? "#7CB685" : "#E5DDD7"),
      ...
      range.label
    )))), /* @__PURE__ */ React.createElement("div", { className: "mb-2" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs mb-3 font-medium tracking-wider", style: { color: "#5A4832" } }, "\u0420\u0410\u0417\u041C\u0415\u0420"), /* @__PURE__ */ React.createElement("div", { className: "flex flex-wrap gap-2" }, sizes.map((size) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: size,
        ...
        className: "px-5 py-3 rounded-2xl text-xs transition-all duration-500 ease-in-out transform hover:scale-105 font-light shadow-sm",
        style: {
          backgroundColor: selectedFilters.size === size ? "#F0EAF2" : "#FFFFFF",
          color: selectedFilters.size === size ? "#4A3540" : "#5A4832",
          border: "1px solid " + (selectedFilters.size === size ? "#C4A1C9" : "#E5DDD7"),
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "max-w-md mx-auto px-4 py-6" }, /* @__PURE__ */ React.createElement("div", { className: "text-sm mb-6 font-medium", style: { color: "#5A4832" } }, "\u041D\u0430\u0439\u0434\u0435\u043D\u043E \u0442\u043E\u0432\u0430\u0440\u043E\u0432: ", filteredRings.length), /* @__PURE__ */ React.createElement("div", { className: "grid grid-cols-2 gap-4" }, filteredRings.map((ring) => /* @__PURE__ */ React.createElement(
    "div",
    {
      key: ring.id,
      className: "backdrop-blur-sm rounded-2xl overflow-hidden transition-all duration-700 ease-out transform hover:scale-[1.02]",
      style: {
        background: "linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(252, 250, 248, 0.95) 100%)",
        boxShadow: "0 8px 24px rgba(238, 193, 229, 0.12)",
        border: "1px solid rgba(238, 193, 229, 0.08)",
        backdropFilter: "blur(20px)"
      },
      onMouseOver: (e) => {
        e.currentTarget.style.boxShadow = "0 12px 32px rgba(238, 193, 229, 0.25)";
        e.currentTarget.style.background = "linear-gradient(135deg, rgba(255, 255, 255, 0.98) 0%, rgba(246, 231, 239, 0.4) 100%)";
      },
      onMouseOut: (e) => {
        e.currentTarget.style.boxShadow = "0 8px 24px rgba(238, 193, 229, 0.15)";
    ...
    /* @__PURE__ */ React.createElement("div", { className: "relative" }, /* @__PURE__ */ React.createElement(
      "div",
      {
        className: "aspect-square flex items-center justify-center relative overflow-hidden select-none touch-pan-x",
        style: {
          background: `linear-gradient(135deg, #FFFFFF 0%, #F7F4EF 50%, #F6E7EF 100%)`
        },
        onTouchStart: (e) => handleTouchStart(e, ring.id),
        onTouchMove: handleTouchMove,
        onTouchEnd: () => handleTouchEnd(ring.id, ring.images.length)
      },
      /* @__PURE__ */ React.createElement(
        "div",
        {
    ...
    ), /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-1" }, ring.images.map((_, index) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: index,
        onClick: () => handleImageChange(ring.id, index),
        className: `w-1.5 h-1.5 rounded-full transition-all duration-500 ease-in-out ${(selectedImageIndex[ring.id] || 0) === index ? "bg-white shadow-md scale-110" : "bg-white/40 hover:bg-white/80"}`
      }
    ))), /* @__PURE__ */ React.createElement("div", { className: "absolute top-2 right-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-black/20 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-full font-medium" }, (selectedImageIndex[ring.id] || 0) + 1, "/", ring.images.length)), ring.id === 1 && /* @__PURE__ */ React.createElement("div", { className: "absolute top-2 left-2" }, /* @__PURE__ */ React.createElement("div", { className: "bg-black/20 backdrop-blur-sm text-white text-xs px-2 py-1 rounded-full" }, "\u{1F446}"))),
    /* @__PURE__ */ React.createElement("div", { className: "p-4" }, /* @__PURE__ */ React.createElement("div", { className: "mb-3" }, /* @__PURE__ */ React.createElement("h3", { className: "font-medium text-sm mb-1 line-clamp-1", style: { color: "#3A2A35" } }, ring.name), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("p", { className: "text-xs font-medium", style: { color: "#5A4832" } }, ring.collection), /* @__PURE__ */ React.createElement("p", { className: "text-sm font-semibold", style: { color: "#3A2A35" } }, ring.price, "\u20BD"))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between mb-3 text-xs" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { style: { color: "#4A3B32" } }, "\u{1F4CF}"), /* @__PURE__ */ React.createElement("span", { style: { color: "#4A3B32" } }, ring.sizes.join(", "))), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1" }, /* @__PURE__ */ React.createElement("span", { style: { color: "#4A3B32" } }, "\u{1F3A8}"), /* @__PURE__ */ React.createElement("span", { style: { color: "#4A3B32" } }, ring.colors.length))), /* @__PURE__ */ React.createElement(
      "button",
      {
        onClick: () => handleOrder(ring),
        className: "w-full py-2.5 rounded-xl text-xs font-medium transition-all duration-500 ease-out transform hover:scale-[1.02]",
        style: {
          background: "linear-gradient(135deg, #E8A5C1 0%, #D68BA8 100%)",
          color: "#FFFFFF",
          boxShadow: "0 4px 16px rgba(232, 165, 193, 0.3)",
          border: "1px solid #E8A5C1"
        },
        onMouseOver: (e) => {
          e.target.style.boxShadow = "0 6px 20px rgba(232, 165, 193, 0.4)";
        },
        onMouseOut: (e) => {
          e.target.style.boxShadow = "0 4px 16px rgba(232, 165, 193, 0.3)";
        }
      },
      "\u0417\u0430\u043A\u0430\u0437\u0430\u0442\u044C"
    ))
    ...
    /* @__PURE__ */ React.createElement("div", { className: "max-w-md mx-auto px-4 py-2" }, /* @__PURE__ */ React.createElement("div", { className: "flex justify-around" }, /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        style: {
          color: currentPage === "catalog" ? "#3A2A35" : "#5A4832",
          transform: currentPage === "catalog" ? "scale(1.05)" : "scale(1)",
          fontWeight: currentPage === "catalog" ? "600" : "500"
        },
        onMouseOver: (e) => {
          if (currentPage !== "catalog") {
            e.currentTarget.style.color = "#3A2A35";
          }
        },
        onMouseOut: (e) => {
          if (currentPage !== "catalog") {
            e.currentTarget.style.color = "#5A4832";
          }
        }
      },
    ...
    "button",
    {
      ...
      style: {
        background: "linear-gradient(135deg, #7CB685 0%, #E8A5C1 100%)",
        color: "#FFFFFF",
        boxShadow: "0 16px 48px rgba(232, 165, 193, 0.4)",
        border: "1px solid #E8A5C1",
        fontWeight: "600"
      },
      onMouseOver: (e) => {
